...
describe('<BlankWhite />', () => {
  it('should render a basic basemap option component', () => {
    const wrapper = shallow(<BlankWhite />, mountOpts())

    expect(wrapper).toMatchSnapshot()
  })
  it('should add a basemap to an empty map when clicked', () => {
    const map = new olMap()
    const wrapper = mount(<BlankWhite />, mountOpts({ map }))
  ...
  it('should set the first layer to a basemap to a map containing a preexisting basemap when clicked with a string layerTypeID.', () => {
    ...
    const wrapper = mount(<BlankWhite map={map} layerTypeID={mockLayerTypeID} />, mountOpts({ map }))
  ...
  it('should fire the callback when the layers are changed', () => {
    ...
    const wrapper = mount(<BlankWhite map={map} onBasemapChanged={callback} />, mountOpts({ map }))
  ...
  it('should render a blue border to indicate when the layer is present on the map', () => {
    const callback = jest.fn()
    const map = new olMap()
    const wrapper = mount(<BlankWhite onBasemapChanged={callback} />, mountOpts({ map }))
