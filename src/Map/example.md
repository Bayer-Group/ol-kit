# Map
The `<Map>` component will either create an [OpenLayers map](https://openlayers.org/en/v4.6.5/apidoc/ol.Map.html) for you or take a prebuilt map as a prop. A reference to this map will be passed down via props to ol-kit child components of `<Map>` via [`connectToContext`](../connectToContext/example.md).
