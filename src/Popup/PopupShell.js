...
class Popup extends Component {
  ...
  mapClickHandler = e => {
    ...
    // set default position with no features selected
    const popupPosition = getPopupPositionFromFeatures(e, [])

    this.setState({ features: [], popupPosition, show: false }, () => {
  ...
  getNewFeatures = async (e, promises) => {
    const { featuresFilter, onMapClick } = this.props
